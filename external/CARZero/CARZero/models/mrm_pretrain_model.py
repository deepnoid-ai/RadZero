...
class MRM(nn.Module):
    ...
    def forward(self, imgs):
        ...
        latent = self.image_encoder(imgs)
...
def mrm_vit_b16(**kwargs):
    ...
    model = load_weight(
        model,
        "/data/haoranlai/Project/MRM_pretrain_vit/output_vit_b16/checkpoint-290.pth",
    )
    return model
...
def mrm_vit_l16(**kwargs):
    ...
    model = load_weight(
        model,
        "/data/haoranlai/Project/MRM_pretrain_vit/output_vit_l16/checkpoint-310.pth",
    )
    return model
